      ...
      <div className="artwork-detail-container loading-overlay">
        ...
        <div className="artwork-detail-content loading-state">
          <div className="detail-skeleton-container">
            <div className="loading-skeleton detail-hero-skeleton" style={{ width: '100%', height: '400px', borderRadius: '16px' }} />
            <div className="detail-info-skeleton">
              <div className="loading-skeleton skeleton-title" style={{ width: '55%', height: '36px' }} />
              <div className="detail-meta-skeleton">
                <div className="loading-skeleton" style={{ width: '100px', height: '20px' }} />
                <div className="loading-skeleton" style={{ width: '140px', height: '20px' }} />
              </div>
              ...
              <div className="detail-actions-skeleton">
                <div className="loading-skeleton" style={{ width: '130px', height: '48px', borderRadius: '24px' }} />
              </div>
            </div>
          </div>
        </div>
