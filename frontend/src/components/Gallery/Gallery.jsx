...
const Gallery = () => {
  ...
  const getVirtualGalleryPath = () => {
    if (username && isAuthenticated && user) {
      return `/u/${username}/gallery/virtual`;
    }
    return `/gallery/virtual`;
  };
    ...
    <div className="gallery-container" data-connection={networkOptimizations.lowerQuality ? 'slow' : 'fast'}>
      ...
      <div className="gallery-page-content">
        ...
        <section className="gallery-filters">
          <div className="virtual-gallery-promo-banner">
            <div className="promo-content">
              <h3>Experience Art in 3D</h3>
              <p>Step inside our virtual exhibition room and explore the collection in an immersive 3D gallery space.</p>
            </div>
            <Link to={getVirtualGalleryPath()} className="enter-3d-btn">
              <span className="btn-icon">🎨</span> Enter 3D Virtual Gallery
            </Link>
          </div>
